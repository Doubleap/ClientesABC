...
public class ComentarioTableAdapter extends TableDataAdapter<Comentario> {
    ...
    public ComentarioTableAdapter(Context context, ArrayList<Comentario> data) {
        super(context, data);
    }
    ...
    public View getCellView(final int rowIndex, final int columnIndex, final ViewGroup parentView) {
        ...
        try {
            ...
            Comentario adjunto = getRowData(rowIndex);
            final String textToShow = adjunto.getValueFromColumn(columnIndex+3);
