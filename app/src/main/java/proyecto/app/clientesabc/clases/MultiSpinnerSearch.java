...
public class MultiSpinnerSearch extends AppCompatSpinner implements OnCancelListener {
    ...
    private String spinnerTitle = "Seleccione los filtros deseados";
    private String emptyTitle = "No existen resultados!";
    private String searchHint = "Buscar...";
    private String clearText = "Limpiar";
    private boolean colorSeparation = true;
    ...
    public boolean performClick() {
        ...
        builder.setPositiveButton(R.string.filtrar, (dialog, which) -> {
