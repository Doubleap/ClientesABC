...
public class ConsultaCreditoClienteAPI extends AsyncTask<Void,String,ArrayList<JsonArray>> {
    ...
    protected ArrayList<JsonArray> doInBackground(Void... voids) {
        ...
        if (mensaje.equals("")) {
            ...
            Call<ResponseBody> call = apiService.ConsultaCreditoCliente(PreferenceManager.getDefaultSharedPreferences(context.get()).getString("CONFIG_SOCIEDAD",VariablesGlobales.getSociedad()),
