...
public class ConsultaClienteAPI extends AsyncTask<Void,String,ArrayList<JsonArray>> {
    ...
    protected ArrayList<JsonArray> doInBackground(Void... voids) {
        ...
        if(mensaje.equals("")) {
            ...
            Call<ResponseBody> call = sincronizacionService.ConsultaCliente(VariablesGlobales.getSociedad(), PreferenceManager.getDefaultSharedPreferences(context.get()).getString("W_CTE_RUTAHH", ""), version, String.format("%10s", String.valueOf(codigoCliente)).replace(' ', '0'));
