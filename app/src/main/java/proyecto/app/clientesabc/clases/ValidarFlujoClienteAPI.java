...
public class ValidarFlujoClienteAPI extends AsyncTask<Void,String,ArrayList<JsonArray>> {
    ...
    AlertDialog dialog;
    public ValidarFlujoClienteAPI(WeakReference<Context> c, WeakReference<Activity> a, String codigoCliente, String tipoFormulario, String numEquipo){
        this.context = c;
        this.activity = a;
    ...
    protected ArrayList<JsonArray> doInBackground(Void... voids) {
        ...
        if(mensaje.equals("")) {
            ...
            Call<ResponseBody> call = sincronizacionService.ValidarFlujoCliente(VariablesGlobales.getSociedad(), PreferenceManager.getDefaultSharedPreferences(context.get()).getString("W_CTE_RUTAHH", ""), version, codigo, tipoFormulario, numEquipo);
