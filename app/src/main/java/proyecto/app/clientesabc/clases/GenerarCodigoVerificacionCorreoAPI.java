...
public class GenerarCodigoVerificacionCorreoAPI extends AsyncTask<Void,String,ArrayList<JsonArray>> {
    ...
    ImageView boton;
    AlertDialog dialog;
    public GenerarCodigoVerificacionCorreoAPI(WeakReference<Context> c, WeakReference<Activity> a, String sociedad, String cliente, String correo, ImageView btn){
        this.context = c;
        this.activity = a;
    ...
    protected ArrayList<JsonArray> doInBackground(Void... voids) {
        ...
        if(mensaje.equals("")) {
            ...
            Call<ResponseBody> call = apiService.GenerarCodigoVerificacionCorreo(PreferenceManager.getDefaultSharedPreferences(context.get()).getString("CONFIG_SOCIEDAD",VariablesGlobales.getSociedad()), codigo, correo);
