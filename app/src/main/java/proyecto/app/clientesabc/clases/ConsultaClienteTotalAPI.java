...
public class ConsultaClienteTotalAPI extends AsyncTask<Void,String,ArrayList<JsonArray>> {
    ...
    AlertDialog dialog;
    public ConsultaClienteTotalAPI(WeakReference<Context> c, WeakReference<Activity> a, String codigoCliente){
        this.context = c;
        this.activity = a;
