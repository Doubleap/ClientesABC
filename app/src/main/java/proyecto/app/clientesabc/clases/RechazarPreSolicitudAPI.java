...
public class RechazarPreSolicitudAPI extends AsyncTask<Void,String,ArrayList<JsonArray>> {
    ...
    AlertDialog dialog;
    public RechazarPreSolicitudAPI(WeakReference<Context> c, WeakReference<Activity> a,String bukrs, String idform, String estado, String comentario){
        this.context = c;
        this.activity = a;
        this.bukrs = bukrs;
        this.idform = idform;
    ...
    protected ArrayList<JsonArray> doInBackground(Void... voids) {
        ...
        if(mensaje.equals("")) {
            ...
            Call<ResponseBody> call = apiService.RechazarPreSolicitud(PreferenceManager.getDefaultSharedPreferences(context.get()).getString("CONFIG_SOCIEDAD",VariablesGlobales.getSociedad()), PreferenceManager.getDefaultSharedPreferences(context.get()).getString("W_CTE_RUTAHH", ""), idform, estado, comentario);
